...
(function (pacman_1) {
    ...
    var Ghost = (function (_super) {
        ...
        Ghost.prototype.paint = function (ctx) {
            ...
            var SPRITE_SIZE = PacmanGame.SPRITE_SIZE;
            var srcX, srcY;
            switch (this._motionState) {
                case MotionState.BLUE:
        ...
        Ghost.prototype._updatePositionEyes = function (maze) {
            ...
            if (this.atIntersection(maze)) {
                ...
                var toRow = Math.floor((game.PENALTY_BOX_EXIT_Y + 8) / PacmanGame.TILE_SIZE); // yToRow(game.PENALTY_BOX_EXIT_Y);
                var toCol = Math.floor((game.PENALTY_BOX_EXIT_X) / PacmanGame.TILE_SIZE); //xToColumn(game.PENALTY_BOX_EXIT_X);
                if (fromCol <= toCol) {
